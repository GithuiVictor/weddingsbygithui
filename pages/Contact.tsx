      ...
      <div className="container mx-auto px-6">
        <header className="text-center mb-24 max-w-2xl mx-auto">
          ...
          <p className="text-neutral-500 font-light italic text-lg leading-relaxed">
            We are currently accepting inquiries for the 2025 and 2026 seasons. Please complete the form below, and we will get back to you within 24 hours.
          </p>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-20">
          <div className="lg:col-span-1 space-y-16">
            <div className="space-y-8">
              <h3 className="text-2xl font-serif text-neutral-900">Studio Details</h3>
              <div className="space-y-6 text-neutral-500">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-light">Available for Destination Weddings Worldwide</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-light">hello@weddingsbygithui.com</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-light">+1 (212) 555-0123</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6">
                <a href="#" className="w-12 h-12 rounded-full border border-neutral-100 flex items-center justify-center hover:border-[#c5a059] hover:text-[#c5a059] transition-all"><Instagram size={18} /></a>
                <a href="#" className="w-12 h-12 rounded-full border border-neutral-100 flex items-center justify-center hover:border-[#c5a059] hover:text-[#c5a059] transition-all"><Youtube size={18} /></a>
                <a href="#" className="w-12 h-12 rounded-full border border-neutral-100 flex items-center justify-center hover:border-[#c5a059] hover:text-[#c5a059] transition-all"><Facebook size={18} /></a>
              </div>
            </div>
            ...
            <div className="p-10 bg-white rounded-[2.5rem] border border-neutral-100 italic text-neutral-400 text-sm font-light shadow-xl">
              "To ensure every couple receives our full artistic focus, we only accept twenty weddings per year. We look forward to hearing your story."
            </div>
          </div>
